    ...
    <div class="container-fluid custom-container p-0" v-if="screenSwitch">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="caption d-flex align-items-start justify-content-center mb-5 mt-1">
            <Triangle_Icon />
            <p class="small-caption">網頁分享超過30款防災學習媒材，自學交流皆適宜。</p>
          </div>
        </div>
      </div>
      <!-- chapter 2 -->
      <div class="container">
        <div class="row">
          ...
          <div class="caption d-flex align-items-start justify-content-center mb-5 mt-1">
            <Triangle_Icon />
            <p class="small-caption">防災地圖猜猜樂，互動遊戲學知識。</p>
          </div>
        </div>
      </div>
      <!-- chapter 3 -->
      <div class="container">
        <div class="row">
          ...
          <div class="caption d-flex align-items-start justify-content-center mb-5 mt-1">
            <Triangle_Icon />
            <a class="small-caption">羅列全國地方政府防災專區，快速掌握各縣市防災資訊。</a>
          </div>
        </div>
      </div>
