      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-6">
            ...
            <img src="@/assets/november/04.png" />
          </div>
    ...
    <div class="container-fluid custom-container p-0" v-if="screenSwitch">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="caption d-flex align-items-start justify-content-center mb-5 mt-1">
            <Triangle_Icon />
            <p class="small-caption">人工智慧近年被廣泛應用在氣象相關產業</p>
          </div>
        </div>
      </div>
      <!-- chapter 2 -->
      <div class="container">
        <div class="row">
          ...
          <div class="caption d-flex align-items-start justify-content-center mb-5 mt-1">
            <Triangle_Icon />
            <p class="small-caption">智慧化天氣判識的4個主要步驟</p>
          </div>
        </div>
      </div>
      <!-- chapter 3 -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="caption d-flex align-items-start justify-content-center mb-5 mt-1">
            <Triangle_Icon />
            <a class="small-caption">人工智慧氣象災害預警技術研發路徑圖</a>
          </div>
        </div>
      </div>
